...
def main():
    ...
    print(f'Treasury deployed at address: ' + Fore.LIGHTGREEN_EX + f'{ _contract_treasury.address }' )
    print("\n")
    ...
    print(f'Token deployed at address: ' + Fore.LIGHTGREEN_EX + f'{ _contract_token.address }' )
    print("\n")
    print(f'Mint tokens Phase, press enter to continue.')
    input()
    print(f'Minting ' + Fore.LIGHTMAGENTA_EX + f'{Web3.fromWei(mintAmount_conf["account1"], "ether")} ETH ' + Fore.RESET + f'--> {signer1.address}')
    ...
    print(f'Minting ' + Fore.LIGHTMAGENTA_EX + f'{Web3.fromWei(mintAmount_conf["account2"], "ether")} ETH ' + Fore.RESET + f'--> {signer2.address}')
    ...
    input()
    print(f'Approving ' + Fore.LIGHTMAGENTA_EX + f'{Web3.fromWei(approvalAmount, "ether")} ETH ' + Fore.RESET + f'--> {_contract_treasury.address}')
    ...
    input()
    print(f'Depositing to {signer1.address} ' + Fore.LIGHTMAGENTA_EX + f'{Web3.fromWei(depositAmount, "ether")} ETH' )
    ...
    singer1_balance = _contract_treasury.functions.balanceOf(_contract_token.address).call({'from': signer1.address})

    print(f'Balance of {signer1.address} is ' + Fore.LIGHTMAGENTA_EX + f'{Web3.fromWei(singer1_balance, "ether")} ETH' )
    print("\n")
